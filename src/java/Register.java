...
public class Register extends HttpServlet {
    ...
    try{
        ...
        java.sql.Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/auth","root",""); 
    ...
    String Query2 = "insert into user values ('"+name+"','"+email+"','"+last_name+"','"+password+"')";
                                                   // out.println(Query2);  
                                                     statement = conn.createStatement();
                                                      ...
                                                      out.println("<head><meta http-equiv='refresh' content='1; URL=http://localhost:15226/Cloud/index.jsp'><meta name='keywords' content='automatic redirection'></head>");
    }
    catch(Exception e)
    {
