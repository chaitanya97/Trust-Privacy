...
@WebServlet("/DecryptKey")
public class DecryptKey extends HttpServlet {
...
//creating connection with the database
    ...
    PreparedStatement ps=con.prepareStatement
            ...
            out.println("<head><meta http-equiv='refresh' content='2; URL=http://localhost:15226/Cloud/Selectoption.jsp\'><meta name='keywords' content='automatic redirection'></head><h1>You  have Key<h1>");
            }
        }     
	catch(Exception e){
...
//creating connection with the database
    ...
    PreparedStatement ps1=con.prepareStatement
        ...
        out.println("<head><meta http-equiv='refresh' content='5; URL=http://localhost:15226/Cloud/Decrypt.jsp\'><meta name='keywords' content='automatic redirection'></head>");
        out.println(Dedata);
    }
